...
public class ConsultaNacionalidade extends javax.swing.JInternalFrame {

    public ConsultaNacionalidade() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite a Nacionalidade do Autor:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Sistema.consultaNacionalidade(jTextField1.getText(), jList1, ConsultaNacionalidade.this);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
        int pos = jList1.getSelectedIndex(); //Posição que foi clicada no Model. (J do Sistema)
        JOptionPane.showMessageDialog(ConsultaNacionalidade.this, livro.get(aux.get(pos)).toString(), 
