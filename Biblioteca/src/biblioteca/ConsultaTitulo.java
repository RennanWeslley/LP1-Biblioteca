...
public class ConsultaTitulo extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Sistema.consultaTitulo(jTextField1.getText(), jList1, ConsultaTitulo.this);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
        int pos = jList1.getSelectedIndex(); //Posição que foi clicada no Model. (J do Sistema)
        JOptionPane.showMessageDialog(ConsultaTitulo.this, livro.get(aux.get(pos)).toString(), 
