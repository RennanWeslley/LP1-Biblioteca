...
public class ConsultaAutor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite o Autor:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Sistema.consultaAutor(jTextField1.getText(), jList1, ConsultaAutor.this);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
        int pos = jList1.getSelectedIndex(); //Posição que foi clicada no Model. (J do Sistema)
        JOptionPane.showMessageDialog(ConsultaAutor.this, livro.get(aux.get(pos)).toString(), 
